...
const Beginner = () => {
  ...
  useEffect(() => {
    const fetchSongs = async () => {
      try {
        const response = await axios.get('/api/songs/beginner');
        ...
        {songs.map((song, index) => (
          ...
          >
            ...
            <button 
              ...
              className="flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full px-4 py-2 mt-2 hover:from-pink-600 hover:to-purple-600 transition"
            >
