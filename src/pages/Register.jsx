        ...
        <div className="w-full md:w-1/2">
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <form className="space-y-4" onSubmit={handleSubmit }>
              ...
              <button type="submit" className="w-full bg-gradient-to-r from-pink-500 to-purple-600  text-white p-2 rounded hover:bg-pink-700" disabled={loading}>{loading ? 'Creating Account...' : 'Create Account'}</button>
              <p className="text-center text-gray-500">You already have an account? <a href="/login" className="text-purple-700">Sign in</a></p>
            </form>
          </div>
        </div>
      </div>
